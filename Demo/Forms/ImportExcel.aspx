<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportExcel.aspx.cs" Inherits="Demo.Forms.ImportExcel" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container py-3">
            <h2 class="text-center text-uppercase">Upload excel file in sql server database using asp.net</h2>
            <div class="card">
